package thuchanhmang.nhom14_10.tuyen.client;
...
class MessageSender extends Thread {
    ...
    public void run() {
        ...
        while (true) {
            try {
                while (!ChatClientUDP.readyToSendMessage()) {
                    Thread.sleep(100);
                }
                sendMessage(">> " + ChatClientUDP.userName + ": " + ChatClientUDP.tf.getText());
				ChatClientUDP.tf.setText("");
            }
            catch(Exception e) {
